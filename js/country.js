...
//贵阳流数据
var GYData = [
    [{ name: '贵阳' }, { name: '美国', value: 112 }],
    [{ name: '贵阳' }, { name: '墨西哥', value: 12 }],
    [{ name: '贵阳' }, { name: '巴西', value: 32 }],
    [{ name: '贵阳' }, { name: '德国', value: 72 }],
    [{ name: '贵阳' }, { name: '韩国', value: 172 }],
]
...
var GZData = [
    ...
    [{ name: '贵阳' }, { name: '太原', value: 90 }],
    [{ name: '贵阳' }, { name: '长春', value: 80 }],
    [{ name: '贵阳' }, { name: '重庆', value: 70 }],
    [{ name: '贵阳' }, { name: '西安', value: 60 }],
    [{ name: '贵阳' }, { name: '成都', value: 50 }],
    [{ name: '贵阳' }, { name: '常州', value: 40 }],
    [{ name: '贵阳' }, { name: '北京', value: 30 }],
    [{ name: '贵阳' }, { name: '北海', value: 20 }],
    [{ name: '贵阳' }, { name: '海口', value: 10 }]
];
...
var color = ['#a6c84c', '#ffa022', '#46bee9','green'];
var series = [];
[ ['国内', GZData],['国外',GYData]].forEach(function (item, i) {
    series.push({
        name: item[0] + ' Top10',
        type: 'lines',
        zlevel: 1,
...
option = {
    ...
    title: {
        text: '喀斯特山区猕猴桃国内外销售情况',
        // subtext: 'caixiaogaung',
        left: 'center',
        textStyle: {
            color: '#16a1f1'
        }
